...
namespace DataContainer.DatabaseSys.Databases.ProjectDatabase
{
    public class ProjectConfigData
    {
        ...
        public ProjectConfigData(in Version version, in Renderer renderer, in bool usesDotNet)
        {
        ...
        public ProjectConfigData Copy()
        {
            ProjectConfigData copy = new(version, renderer, usesDotNet);
        ...
        public bool HasDifferentTags(in ProjectConfigData other)
        {
        ...
        public bool HasDifferentFeatureData(in ProjectConfigData other)
        {
